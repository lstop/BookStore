			...
			<tr>
				<td width="25%">
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="UserLogoutServlet">用戶退出</a>
							</td>
						</tr>
					</table></td>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form action="EditUserServlet?id=${login_user.id}" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;
												<input type="radio" name="gender" value="男" checked="${login_user.gender.equals("女")?'checked':''}"/> 男
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="radio" name="gender" value="女" checked="${login_user.gender.equals("男")?'checked':''}"/> 女
											</td>
										</tr>
										<tr>
